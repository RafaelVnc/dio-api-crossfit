...
from dio_fastapi_crossfit.centro_treinamento.schemas import CentroTreinamentoIn, CentroTreinamentoOut
from dio_fastapi_crossfit.centro_treinamento.models import CentroTreinamentoModel
